"use strict";(self.webpackChunktecno_mobile_minds_strapi=self.webpackChunktecno_mobile_minds_strapi||[]).push([[851],{38566:(xt,k,n)=>{n.d(k,{c:()=>B});var t=n(74081),_=n(72450),L=n(93415),f=n(84366),x=n(10701),F=n(32370);const S=(0,_.ZP)(L.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
